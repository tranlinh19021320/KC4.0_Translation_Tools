...
def add_fresh_jobs(background_task_scheduler, BACKGROUND_TASKS):
    ...
    from tests.background_tasks.detect_plain_text_language_created_by_public_request.main import test_main
    
    background_task_1_conf = BACKGROUND_TASKS['test_detect_plain_text_language_created_by_public_request']
