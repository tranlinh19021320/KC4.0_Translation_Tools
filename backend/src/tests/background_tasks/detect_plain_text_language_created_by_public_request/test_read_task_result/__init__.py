...
def add_fresh_jobs(background_task_scheduler, BACKGROUND_TASKS):
    ...
    from tests.background_tasks.detect_plain_text_language_created_by_public_request.test_read_task_result.main import test_read_task_result
    
    background_task_1_conf = BACKGROUND_TASKS['test_read_task_results_by_public_request']
