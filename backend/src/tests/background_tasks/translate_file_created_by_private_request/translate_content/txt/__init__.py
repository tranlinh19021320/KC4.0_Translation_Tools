...
def add_fresh_jobs(background_task_scheduler, BACKGROUND_TASKS):
    from tests.background_tasks.translate_file_created_by_private_request.translate_content.txt.main import test_read_task_result, test_mark_invalid_tasks, test_execute_in_batch, test_main
