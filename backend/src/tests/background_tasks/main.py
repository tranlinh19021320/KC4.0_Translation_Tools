...
def init_test_background_tasks(config: GlobalConfig):
    ...
    from tests.background_tasks.detect_plain_text_language_created_by_private_request.test_read_task_result import add_fresh_jobs as add_fresh_jobs_2
    from tests.background_tasks.detect_plain_text_language_created_by_private_request.test_mark_invalid_tasks import add_fresh_jobs as add_fresh_jobs_3
    from tests.background_tasks.detect_plain_text_language_created_by_private_request.test_main import add_fresh_jobs as add_fresh_jobs_4
    from tests.background_tasks.detect_plain_text_language_created_by_private_request.test_execute_in_batch import add_fresh_jobs as add_fresh_jobs_5
    from tests.background_tasks.detect_plain_text_language_created_by_public_request.test_read_task_result import add_fresh_jobs as add_fresh_jobs_6
    from tests.background_tasks.detect_plain_text_language_created_by_public_request.test_mark_invalid_tasks import add_fresh_jobs as add_fresh_jobs_7
    from tests.background_tasks.detect_plain_text_language_created_by_public_request.test_main import add_fresh_jobs as add_fresh_jobs_8
    from tests.background_tasks.detect_plain_text_language_created_by_public_request.test_execute_in_batch import add_fresh_jobs as add_fresh_jobs_9
