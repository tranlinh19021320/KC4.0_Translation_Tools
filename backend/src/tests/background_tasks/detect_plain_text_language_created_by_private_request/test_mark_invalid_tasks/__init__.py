...
def add_fresh_jobs(background_task_scheduler, BACKGROUND_TASKS):
    ...
    from tests.background_tasks.detect_plain_text_language_created_by_private_request.test_mark_invalid_tasks.main import test_mark_invalid_tasks
    
    background_task_1_conf = BACKGROUND_TASKS['test_mark_invalid_tasks_detect_by_private_request']
