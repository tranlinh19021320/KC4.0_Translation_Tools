from modules.background_tasks.detect_plain_text_language_created_by_private_request.main import read_task_result,mark_invalid_tasks
import pymongo
import asyncio
...
async def test_mark_invalid_tasks():
    ...
    print("result of mark_invalid_tasks:", mark_invalid_tasks(invalid_tasks_mapper))
