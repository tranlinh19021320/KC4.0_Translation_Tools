...
def add_fresh_jobs(background_task_scheduler, BACKGROUND_TASKS):
    ...
    from tests.background_tasks.detect_plain_text_language_created_by_private_request.test_execute_in_batch.main import test_execute_in_batch
    
    background_task_1_conf = BACKGROUND_TASKS['test_execute_in_batch_detect_by_private_request']
